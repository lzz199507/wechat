<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"E:\xampp\htdocs\2017\Wechat\rhaphp-master/application/install\view\index\complete.html";i:1509352067;s:83:"E:\xampp\htdocs\2017\Wechat\rhaphp-master/application/install\view\public\base.html";i:1509352067;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<p style="text-align: center">为了系统更加的安全，我们建议你删除install目录。</p>
<div class="row">
	<div class="col-sm-12">
		<ul class="list-group">
			<li class="list-group-item"><a href="http://www.rhaphp.com" target="_blank">RhaPHP官方网站</a></li>
			<li class="list-group-item"><a href="http://ask.rhaphp.com/" target="_blank">RhaPHP开发文档</a></li>
		</ul>
	</div>
</div>
