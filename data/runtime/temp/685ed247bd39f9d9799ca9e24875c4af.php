<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\xampp\htdocs\2017\Wechat\rhaphp-master\themes\pc\admin\system\adminmember.html";i:1509352067;s:74:"E:\xampp\htdocs\2017\Wechat\rhaphp-master\themes\pc\admin\common\base.html";i:1509352067;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<a href="<?php echo url('addAdminMember'); ?>"  class="layui-btn layui-btn-normal layui-btn-small rha-nav-title">增加成员</a>
</h2>
        </div>
        <?php endif; ?>
...
<table class="layui-table" lay-even="" lay-skin="nob">
    ...
    <tr>
        ...
        <td><?php echo date('Y-m-d H:s:i',$vo['last_time']); ?></td>
        <td><?php echo $vo['ip']; ?></td>
        <td><?php if($vo['status'] == '1'): ?>正常<?php else: ?>禁用中<?php endif; ?></td>
        <td>
            <?php if($vo['status'] == '1'): ?>
            <a class="rha-bt-a" onclick="disabledAdmin('<?php echo $vo['id']; ?>','0')" href="javascript:;">禁用</a>
            <?php else: ?><a class="rha-bt-a" onclick="disabledAdmin('<?php echo $vo['id']; ?>','1')" href="javascript:;">开启</a><?php endif; ?>
            <a class="rha-bt-a" href="<?php echo url('updatePwd',['id'=>$vo['id']]); ?>">改密码</a>
        </td>
    </tr>
    <?php endforeach; endif; else: echo "" ;endif; ?>
    </tbody>
    ...
    function disabledAdmin(id,status) {
        layui.use('layer', function(){
            ...
            layer.confirm('你确定需要禁用吗？', {
                ...
                $.post("<?php echo url('disabledAdmin'); ?>",{'id':id,'status':status},function (res) {
                    if(res.status==1){
