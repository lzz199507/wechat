<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\xampp\htdocs\2017\Wechat\rhaphp-master\themes\pc\admin\system\menulist.html";i:1509352067;s:74:"E:\xampp\htdocs\2017\Wechat\rhaphp-master\themes\pc\admin\common\base.html";i:1509352067;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<a href="<?php echo url('addMenu'); ?>"  class="layui-btn layui-btn-normal layui-btn-small rha-nav-title">增加菜单</a>
</h2>
        </div>
        <?php endif; ?>
...
<table class="layui-table">
    ...
    <?php if(is_array($menuList) || $menuList instanceof \think\Collection || $menuList instanceof \think\Paginator): $i = 0; $__LIST__ = $menuList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
        <tr>
            ...
            <td><a class="rha-bt-a" href="<?php echo url('updateMenu',['id'=>$v['id']]); ?>">修改</a> <a href="javascript:;" onclick="delMenu('<?php echo $v['id']; ?>')" class="rha-bt-a" >删除</a></td>
        </tr>
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <button class="layui-btn  layui-btn-small" lay-submit lay-filter="updateSort">更新排序</button>
        </div>
    </div>
</form>
<script>
