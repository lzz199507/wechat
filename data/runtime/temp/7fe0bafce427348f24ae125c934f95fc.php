<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"E:\xampp\htdocs\2017\Wechat\rhaphp-master\themes\pc\admin\app\index.html";i:1509352067;s:74:"E:\xampp\htdocs\2017\Wechat\rhaphp-master\themes\pc\admin\common\base.html";i:1509352067;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<table class="layui-table" lay-even lay-skin="nob">
    ...
    <tr>
        ...
        <td>
            ...
            <?php if($vo['upgrade'] == '1'): ?>
            <a class="layui-btn layui-btn-mini layui-btn-warm" href="javascript:;" onclick="upgrade('<?php echo $vo['addon']; ?>')">升级</a>
            <?php endif; ?>
        </td>
    </tr>
    <?php endforeach; endif; else: echo "" ;endif; ?>
